...
(function (global, factory) {
    ...
    */
    ...
    module$exports$google3$third_party$tensorflow_lite_support$web$tflite_web_api_client.TFLiteWebModelRunner.createFromBuffer = function (model_int_array, b) {
        return (0, module$exports$google3$third_party$javascript$tslib$tslib.__awaiter)(this, void 0, void 0, function d() {
            ...
            return $jscomp.generator.createGenerator(d, function (t) {
                ...
                if (3 != t.nextAddress) return h = g.call(f, t.yieldResult), k = h.next().value, l = h.next().value, t.yield(Promise.resolve(), 3);
                n = model_int_array;
                r = k._malloc(n.length);
                k.HEAPU8.set(n, r);
                q = e.getWASMFeatures();
     ...
     * =============================================================================
     */
    var DEFAULT_TFLITE_MODEL_RUNNER_OPTIONS = {
        numThreads: -1,
    };
    ...
    var TFLiteModel = /** @class */ (function () {
        ...
        TFLiteModel.prototype.predict = function (inputs, config) {
            ...
            // Named tensors.
                ...
                for (var _i = 0, inputTensorNames_1 = inputTensorNames; _i < inputTensorNames_1.length; _i++) {
                    var name_1 = inputTensorNames_1[_i];
                    this.setModelInputFromTensor(modelInputMap_1[name_1], inputs[name_1]);
                }
            }
            // Run inference.
            ...
            for (var i = 0; i < modelOutputs.length; i++) {
                ...
                var outputTensor = tfjsCore.tensor(modelOutput.data(), this.getShapeFromTFLiteTensorInfo(modelOutput));
     ...
     * @doc {heading: 'Models', subheading: 'TFLiteModel'}
     */
    function loadTFLiteModel(modelUrl, options) {
        if (options === void 0) { options = DEFAULT_TFLITE_MODEL_RUNNER_OPTIONS; }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, undefined(modelUrl, options)];
                    case 1:
    ...
    function loadTFLiteModelFromBuffer(buffer, options) {
        if (options === void 0) { options = DEFAULT_TFLITE_MODEL_RUNNER_OPTIONS; }
        return __awaiter(this, void 0, void 0, function () {
            var tfliteModelRunner;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, undefined(buffer, options)];
                    case 1:
                        tfliteModelRunner = _a.sent();
                        return [2 /*return*/, new TFLiteModel(tfliteModelRunner)];
                }
...
//# sourceMappingURL=tf-tflite.js.map
