...
export declare interface TFLiteWebModelRunnerClass {
     ...
     */
    create(modelPath: string, options: TFLiteWebModelRunnerOptions): Promise<TFLiteWebModelRunner>;
    createFromBuffer(model_int_array: Uint8Array, options: TFLiteWebModelRunnerOptions): Promise<TFLiteWebModelRunner>;
}
/**
