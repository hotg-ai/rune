...
export declare interface ObjectDetectorClass {
     ...
     */
    create(modelPath: string, options?: ObjectDetectorOptions): Promise<ObjectDetector>;
}
...
export declare class ObjectDetector {
    ...
    detect(input: ImageData | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement): DetectionResult | undefined;
