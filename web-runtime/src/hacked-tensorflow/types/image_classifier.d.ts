...
export declare interface ImageClassifierClass {
     ...
     */
    create(modelPath: string, options?: ImageClassifierOptions): Promise<ImageClassifier>;
}
...
export declare class ImageClassifier {
    ...
    classify(input: ImageData | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement): ClassificationResult | undefined;
