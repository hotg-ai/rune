...
export declare interface ImageSegmenterClass {
     ...
     */
    create(modelPath: string, options?: ImageSegmenterOptions): Promise<ImageSegmenter>;
}
export declare class ImageSegmenter {
    /** Performs segmentation on the given image-like element. */
    segment(input: ImageData | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement): SegmentationResult | undefined;
