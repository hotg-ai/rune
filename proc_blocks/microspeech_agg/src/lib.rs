...
impl<const N: usize> MicrospeechAgg<N> {
    pub fn new() -> Self {
        MicrospeechAgg {
            labels: [""; N],
...
impl<const N: usize> Default for MicrospeechAgg<N> {
    fn default() -> Self { MicrospeechAgg::new() }
}
