...
/// A struct that gives the size of the game's components ratioed by the board size.
...
impl GameSize {
    ...
    /// Calculates the amount that the tile should get increased by when a merge occur.
