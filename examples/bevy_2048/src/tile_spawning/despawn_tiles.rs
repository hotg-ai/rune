//! This module contains the implementation of the Despawn component and its
//! system.
use bevy::prelude::*;
...
/// This system removing all the unuseful components from a tile that should be
/// despawned. also adding the despawn animation.
